...
def register():
    ...
    user_to_register = User(username=data["username"], email=email.email, password=password.password)
    
    register_instance = Register()
    register_instance.register_user(username=data['username'],email=email,password=password)
